...
from .models import Food, Shopping, Info, Recipe, Memo
from .serializers import FoodSerializer, ShoppingSerializer, PostSerializer, RecipeSerializer, MemoSerializer
...
class FoodViewSet(viewsets.ModelViewSet):
	...
	#serializer.save(food_name=self.request.user,
